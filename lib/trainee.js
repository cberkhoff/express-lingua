...
module.exports = (function() {
    ...
    Trainee.prototype.determineLocales = function(req, res) {
        ...
        if (locale) {
            ...
            return this._extractLocales(headers);
        }
    };
    ...
    //
    // description:
    //    Persists the given locale in the req.session object.
    //
    Trainee.prototype.persist = function(req, locale) {
